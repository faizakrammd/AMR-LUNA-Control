...
void setup() {
  ...
  // Ensure encoder counts start from 0 after calibration
  leftEncoderCount  = 0;
  rightEncoderCount = 0;
...
void loop() {
  ...
  switch(state) {
    ...
    case 0: {
      ...
      leftSpeed  = constrain(BASE_SPEED + (int)correction, 0, 255);
      rightSpeed = constrain(BASE_SPEED - (int)correction, 0, 255);
    ...
    case 1: {
      ...
      leftSpeed  = constrain( turnSpeed, -255, 255);
      rightSpeed = constrain(-turnSpeed, -255, 255);
